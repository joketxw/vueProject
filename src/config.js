...
//武汉钱赚宝
const cdnIp = 'm.wlwch.cn';
//const host = 'ws.wlwch.cn';
const host = '192.168.1.11:8080';
...
const ip = {
	user : 'http://'+ host +'/user',
	customer : 'http://'+ host +'/customer',
	portal : 'http://'+ host +'/portal',
	robBuy : 'http://'+ host +'/robBuy',
	trade : 'http://'+ host +'/trade',
	room : 'http://'+ host +'/room',
	order:'http://'+ host +'/',
    lottery:'http://'+ host +'/lottery',
    auction:'http://'+ host +'/auction',
	customerDetailsUrl : 'http://www.wlwch.cn/rd-platform/onlineUser/userDetails.do'
};
const ws = {
...
const kuai3={
  	isShow: true,
  	gxkuai3:'http://gx.wlwch.cn/',
  	//gxkuai3:'http://192.168.1.11:8282/',
  	hbkuai3:'http://hb.wlwch.cn/',
  	ahkuai3:'http://ah.wlwch.cn/',
};
module.exports = {
	host : host,
	cdnIp : cdnIp,
